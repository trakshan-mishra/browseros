...
const initialState = {
  ...
  activeWindowId: null,
  focusedAppId: null,
  dockApps: ['finder', 'terminal', 'notes', 'browser', 'calculator', 'settings', 'ai-assistant', 'sensors'],
  runningApps: [],
  notifications: [],
  spotlightOpen: false,
  wallpaper: 0,
...
function osReducer(state, action) {
  switch (action.type) {
    case 'OPEN_WINDOW': {
      ...
      const newWindow = {
        id, appId: action.payload.appId, title: action.payload.title || action.payload.appId,
